...
@ApplicationScoped
public class VersionRepository implements PanacheMongoRepositoryBase<Version, Long> {
    ...
    public ArtifactMetaData getArtifactMetadata(String artifactId) {
        ...
        artifactMetaData.setModifiedOn(version.createdOn.toEpochDay());
        ...
        artifactMetaData.setCreatedOn(version.artifact.createdOn.toEpochDay());
    ...
    public Version createVersion(boolean firstVersion, Artifact artifact, String name, String description, ArtifactState state,
        ...
        version.createdOn = LocalDate.from(createdOn.toInstant());
    ...
    private SearchedArtifact buildFromVersion(Version version) {
        ...
        searchedArtifact.setCreatedOn(Instant.from(version.artifact.createdOn).toEpochMilli());
        searchedArtifact.setDescription(version.description);
        searchedArtifact.setId(version.artifact.artifactId);
        searchedArtifact.setLabels(SerializationUtil.deserializeLabels(version.labelsStr));
        searchedArtifact.setModifiedBy(version.createdBy);
        searchedArtifact.setModifiedOn(Instant.from(version.createdOn).toEpochMilli());
