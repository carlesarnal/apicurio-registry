...
public class ReadOnlyRegistryStorageTest {
    ...
    static {
        EXPECTED_METHODS = Map.<String, State> ofEntries(
                ...
                entry("countVersionsModifiedSince1",
                        new State(false, s -> s.countVersionsModifiedSince(System.currentTimeMillis()))),
                ...
                entry("createArtifactVersion10",
                        new State(true,
                                s -> s.createArtifactVersion(null, null, null, null, null, null, null, false,
                                        false, null))),
                entry("createArtifactVersionIfLatest11",
                        new State(true,
                                s -> s.createArtifactVersionIfLatest(null, null, null, null, null, null, null,
                                        false, null, 0, null))),
                ...
                entry("getArtifactContractRuleset2",
                        new State(false, s -> s.getArtifactContractRuleset(null, null))),
                entry("setArtifactContractRuleset3",
                        new State(true, s -> s.setArtifactContractRuleset(null, null, null))),
                entry("deleteArtifactContractRuleset2",
                        new State(true, s -> s.deleteArtifactContractRuleset(null, null))),
                entry("getVersionContractRuleset3",
                        new State(false, s -> s.getVersionContractRuleset(null, null, null))),
                entry("setVersionContractRuleset4",
                        new State(true, s -> s.setVersionContractRuleset(null, null, null, null))),
                entry("deleteVersionContractRuleset3",
                        new State(true, s -> s.deleteVersionContractRuleset(null, null, null))),
                entry("importContractRule1", new State(true, s -> s.importContractRule(null))),
                entry("getContractRulesByTag1",
                        new State(false, s -> s.getContractRulesByTag(null))),
