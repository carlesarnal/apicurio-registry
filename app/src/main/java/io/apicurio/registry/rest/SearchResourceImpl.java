...
public class SearchResourceImpl  implements SearchResource, Headers{
    ...
    /**
     * @see io.apicurio.registry.rest.SearchResource#searchArtifacts(String, Integer, Integer)
     */
    @Override
    public ArtifactSearchResults searchArtifacts(String search, Integer offset, Integer limit) {

        return registryStorage.searchArtifacts(search, offset, limit);
    }
}
